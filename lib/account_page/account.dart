...
import 'package:login/account_page/cubit/account_state.dart';
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: state.user.avatar != null
                          ...
                          : const AssetImage("image/rice.jpg") as ImageProvider,
                    ),
                    const SizedBox(width: 20),
                    Column(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ElevatedButton(
                        onPressed: () async {
                          final result = await context.read<AccountCubit>().deleteAccount();
                          print(result);
